            ...
            <div id="listaLogin">
                ...
                <form action="SiautoController" method="get">
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th class="tbhead" colspan="5">Listas de Peça Disponíveis</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="tbhead" colspan="5"></th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr>
                                <th class="tbfoot" colspan="3"></th>
                                <th class="tbfoot">
                                    <button type="submit">adicionar peças</button>
                                </th>
                                <th class="tbfoot">
