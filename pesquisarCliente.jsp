    ...
    <body>
        ...
        <div id="listaLogin">
            <table>
                <thead>
                    <tr>
                        <th class="tbhead" colspan="11">Lista de Cliente</th>
                    </tr>
                    <tr>
                        <th>Nome</th>
                        <th>CPF</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="SiautoController?entidade=cliente&oper=getClienteId&id=${cliente.idCliente}">alterar</a>
                        </td>
                        <td>
                            <a href="SiautoController?entidade=cliente&oper=excluirCliente&id=${cliente.idCliente}">excluir</a>
                        </td>
                    </tr>
                <%
                    }
